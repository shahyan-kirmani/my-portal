...
let schema = yup.object().shape({
  ...
  developers: yup.mixed().required("Developers is Required"),
...
// myHeaders.append("Content-Type", "application/x-www-form-urlencoded");
   ...
   let response  =  await axios.post(`${base_url}project/create`, params)

      if (response.data.status === "ok") {
        toast.success("Project Added Successfully!");
        navigate("/admin/project_list");
      }
  ...
  <option value="sell">Sale</option>
                  ...
                  <div className="form-group col-sm-6">
                    ...
                    <input
                      ...
                      name="developers"
                      className="form-control"
                      placeholder="Enter Featured Developers"
                      onChange={formik.handleChange("developers")}
                      onBlur={formik.handleBlur("developers")}
