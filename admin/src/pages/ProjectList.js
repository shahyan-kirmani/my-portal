...
const ProjectList = () => {
            ...
            {listing[i]?.featured === true ? (
              <input
                ...
                onClick={() => {
                  ...
                  axios
                    .put(`${base_url}project/update/${listing[i]?.id}`, params)
                    .then((res) => {
  ...
  const deleteContact = (e) => {
    axios
      .delete(`${base_url}project/delete/${e}`)
      .then((res) => {
        if (res.data.status === "ok") {
